...
### Task 3 :  Copy the newly generated lef and associated required lib files to 'picorv32a' design 'src' directory.
```# Copy lef file
...
# List and check whether it's copied
ls ~/Desktop/work/tools/openlane_working_dir/openlane/designs/picorv32
a/src/bash

```

<img width="1920" height="1080" alt="Screenshot from 2026-07-17 00-31-32" src="https://github.com/user-attachments/assets/6f344eae-4f4c-4917-b4e5-ce8535dee7b8" />

and edit the config.tcl file and add the following commands to include our custom design in the OpenLane flow
...
<img width="1920" height="1080" alt="Screenshot from 2026-07-17 00-36-47" src="https://github.com/user-attachments/assets/5f22d180-cf42-4711-a6eb-88547692bf8c" />

## Now running the OpenLane flow synthesis with the newly inserted custom cell

The following commmands are used to invoke the OpenLane and run synthesis
...
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/3c6b4464-6318-42d5-ad99-dd3e32020b1a" />

Since we are having 0 wns after the modified timing run, we are going to do timing analysis on initial run of synthesis which has lots of violations and no parameters were added to improve timing
...
#set rst_index [lsearch [all_inputs] [get_port reset]]
set all_inputs_wo_clk [lreplace [all_inputs] $clk_index $clk_index]
#set all_inputs_wo_clk_rst [lreplace $all_inputs_wo_clk $rst_index $rst_index]
...
## Generation of the PDN of the design picorv32a

The following commands are used to invoke the OpenLane and run the design
```bash
# Change directory to openlane flow directory
cd Desktop/work/tools/openlane_working_dir/openlane
...
### Now we're going to do an post route parasitic extraction using SPEF extractor
The following command should be executed in order to extract
```bash
# Change directory
cd Desktop/work/tools/SPEF_EXTRACTOR

# Command extract spef
python3 main.py /home/vsduser/Desktop/work/tools/openlane_working_dir/openlane/designs/picorv32a/runs/17-07_18-04/tmp/merged.lef /home/vsduser/Desktop/work/tools/openlane_working_dir/openlane/designs/picorv32a/runs/26-03_08-45/results/routing/picorv32a.def
```

### Then with the extracted parasitic of the route we're going to do an post-route OpenSTA timing analysis

The following are the commands to be run in OpenLANE flow to do OpenROAD timing analysis with integrated OpenSTA in OpenROAD
...
# Reading lef file
read_lef /openLANE_flow/designs/picorv32a/runs/17-07_18-04/tmp/merged.lef

# Reading def file
read_def /openLANE_flow/designs/picorv32a/runs/17-07_18-04/results/routing/picorv32a.def
...
read_verilog /openLANE_flow/designs/picorv32a/runs/17-07_18-04/results/synthesis/picorv32a.synthesis_preroute.v
...
# Read SPEF
read_spef /openLANE_flow/designs/picorv32a/runs/17-07_18-04/results/routing/picorv32a.spef
